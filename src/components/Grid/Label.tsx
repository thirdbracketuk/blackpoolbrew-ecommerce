...
export const Label: React.FC<Props> = ({ amount, position = 'bottom', title }) => {
  return (
    ...
    >
      <div className="flex items-end justify-between text-sm grow font-semibold ">
        <h3 className="mr-4 text-sm line-clamp-2 border p-2 px-3 leading-none tracking-tight rounded-lg bg-white/70 text-black backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white">
          {title}
        </h3>
