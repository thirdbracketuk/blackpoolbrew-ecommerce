  ...
  return (
    <Sheet onOpenChange={setIsOpen} open={isOpen}>
      ...
      <SheetContent className="flex flex-col">
        ...
        {!cart || cart?.items?.length === 0 ? (
          <div className="flex grow flex-col items-center justify-center gap-4 text-center px-6">
                  ...
                  return (
                    <li className="flex w-full flex-col" key={i}>
                      <div className="relative flex w-full flex-row justify-between px-1 py-4">
                        ...
                        <Link
                          className="z-30 flex flex-row space-x-4 items-start"
                          href={`/products/${(item.product as Product)?.slug}`}
                        >
                          <div className="relative h-20 w-20 cursor-pointer overflow-hidden rounded-lg border border-border bg-muted shrink-0">
                            {image?.url && (
                              <Image
                                alt={image?.alt || product?.title || ''}
                                className="h-full w-full object-cover"
